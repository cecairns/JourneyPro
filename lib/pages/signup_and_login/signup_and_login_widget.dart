                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                      SizedBox(
                                        width: 350.0,
                                        child: TextFormField(
                                          key: const ValueKey('sign-upEmail_dm1t'),
                                          controller:
                                      ...
                                      SizedBox(
                                        width: 350.0,
                                        child: TextFormField(
                                          key: const ValueKey('SignupPass_a8py'),
                                          controller:
                                      ...
                                      SizedBox(
                                        width: 350.0,
                                        child: TextFormField(
                                          key: const ValueKey('ConfirmPass_sz44'),
                                          controller:
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    SizedBox(
                                      width: 350.0,
                                      child: TextFormField(
                                        key: const ValueKey('loginEmail_w7y6'),
                                        controller:
                                    ...
                                    SizedBox(
                                      width: 350.0,
                                      child: TextFormField(
                                        key: const ValueKey('loginPass_jm9g'),
                                        controller:
                  ...
                  Stack(
                    children: [
                      ...
                      if (_model.tabBarCurrentIndex == 0)
                        FFButtonWidget(
                          key: const ValueKey('SignUpButton_mojk'),
                          onPressed: () async {
                            logFirebaseEvent(
